...
export const OP_INDUSTRIES: Industry[] = [
  ...
  {
    id: 'apparel', label: 'Apparel mfg', tagline: 'Boutique apparel brand',
    persona: { name: 'Sara M.', initials: 'SM', role: 'Founder & Creative Director', company: 'Boutique Apparel Brand' },
    date: 'Friday · May 30',
    streak: '198h streak',
    kpis: [
...
export const OP_TEAMS: Record<string, TeamMember[]> = {
  ...
  apparel: [
    { name: 'Maya Cole', initials: 'MC', role: 'Wholesale Lead', picks: 'Buyer reorders & line sheets' },
